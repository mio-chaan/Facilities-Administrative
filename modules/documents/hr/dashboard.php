...
<div class="t8-docs-dashboard">
    ...
    <div class="t8-docs-kpi-grid" aria-label="Document summary">
        <a class="t8-docs-kpi t8-docs-kpi-red t8-docs-kpi-link" href="<?= e(page_url('documents', ['action' => 'browse', 'view' => 'all'])) ?>" aria-label="Browse all active documents"><div class="t8-docs-kpi-icon"><i class="fa-solid fa-file-lines"></i></div><div><span>Total Documents</span><strong><?= e((string) $hrStats['total_documents']) ?></strong><small>All active records</small></div></a>
