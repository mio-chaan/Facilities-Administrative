...
switch ($action) {
    ...
    case 'cancel':
        ...
        if (!$target || !in_array($target['status'], ['pending', 'approved'], true)) {
                            ...
                            <?php foreach ($myReservations as $r): ?>
                                ...
                                <tr <?= $r['has_conflict'] ? 'style="background: rgba(230,126,34,0.14);"' : '' ?>>
                                    ...
                                    <td style="display:flex; gap:8px; flex-wrap:wrap;">
                                        ...
                                        <?php elseif ($r['status'] === 'approved' && ($r['cancellation_decision'] ?? '') === 'rejected'): ?>
                                            <span class="t8-help-text">Cancellation request was rejected.</span>
                                        <?php else: ?>
                                            <span class="t8-help-text">—</span>
                                        <?php endif; ?>
                                    </td>
