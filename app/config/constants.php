...
const T8_RESERVATION_STATUSES = ['pending', 'approved', 'rejected', 'pending', 'cancelled', 'completed', 'expired'];
const T8_VISIT_STATUSES       = ['scheduled', 'late', 'checked_in', 'checked_out', 'cancelled', 'expired'];
